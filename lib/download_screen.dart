...
class DownloadScreenState extends State<DownloadScreen> {
  ...
  static final List<ChartCategory> _allCharts = [
    ...
    ChartCategory(
      ...
      _absentColor,
      [
        Chart('Northeast',    _absentColor, _absentIcon, 'ELEV_NE_NEW',  _stateAbsentNone, "", ValueNotifier<int>(0), true, Download(), false),
        Chart('North Central', _absentColor, _absentIcon, 'ELEV_NC_NEW',  _stateAbsentNone, "", ValueNotifier<int>(0), true, Download(), false),
        Chart('Northwest',    _absentColor, _absentIcon, 'ELEV_NW_NEW',  _stateAbsentNone, "", ValueNotifier<int>(0), true, Download(), false),
