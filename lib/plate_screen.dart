...
import 'package:avaremp/plate_profile.dart';
...
class PlateScreenState extends State<PlateScreen> {
  ...
  late final PlateProfileController _profileController;

  @override
  void initState() {
    super.initState();
    _profileController = PlateProfileController(
      onRebuild: () {
        if (!mounted) {
          return;
        }
      ...
      onPaint: _notifyPaint,
      isMounted: () => mounted,
    );
    _profileController.initFromSettings();
  }
  ...
  Widget _makeContent(PlatesFuture? future) {
    ...
    _profileController.syncForPlate(Storage().currentPlate);
    _loadPlate();
    ...
    _profileController.updateSelectedProcedure(procedureNames);
  ...
  Widget makePlateView(List<String> airports, List<String> plates, List<String> procedures, List<Destination> business, double height, ValueNotifier notifier) {
    ...
    return Scaffold(body: Stack(children: [
      ...
      _profileController.buildOverlay(context, notifier),
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: CircleAvatar(
                      ...
                      child: IconButton(
                        ...
                        icon: Icon(_profileController.isVisible ? Icons.visibility : Icons.visibility_off, size: 16),
                        onPressed: _profileController.toggleVisibility,
                      ),
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child:DropdownButtonHideUnderline(
                        child:DropdownButton2<String>(
                          ...
                          isExpanded: false,
                          value: procedures.contains(_profileController.selectedProcedure) ? _profileController.selectedProcedure : procedures[0],
                          ...
                          onChanged: (value) {
                            ...
                            _profileController.selectProcedure(value);
                          },
                        )
                    )
                  ),
                  ...
                  Padding(
                    ...
                    child: TextButton(
                      onPressed: _profileController.selectedProcedure == null ? null : () {
                        _profileController.setProfileFromProcedure(_profileController.selectedProcedure!);
                      },
                  ...
                  Padding(
                    ...
                    child: TextButton(
                      onPressed: _profileController.selectedProcedure == null ? null : () {
                        _profileController.addProcedureToPlan(_profileController.selectedProcedure!, context);
                      },
