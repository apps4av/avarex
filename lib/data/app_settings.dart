...
class AppSettings {
  ...
  List<String> getLayers() {
    return (provider.getValue("key-layers-v49", defaultValue:
  ...
  List<double> getLayersOpacity() {
    return (provider.getValue("key-layers-opacity-v49", defaultValue:
  ...
  void setLayersOpacity(List<double> opacity) {
    provider.setString("key-layers-opacity-v49", opacity.map((double e) => e.toString()).toList().join(","));
  }
