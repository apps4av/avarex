...
class MBTilesRasterTileProvider extends TileProvider {
  final MbTiles mbtiles;
  static final MemoryImage transparentImage = MemoryImage(Uint8List.fromList(const [
    137, 80, 78, 71, 13, 10, 26, 10, 0, 0, 0, 13, 73, 72, 68, 82,
    0, 0, 0, 1, 0, 0, 0, 1, 8, 6, 0, 0, 0, 31, 21, 196, 137,
    0, 0, 0, 13, 73, 68, 65, 84, 8, 215, 99, 96, 96, 96, 0, 0,
    0, 5, 0, 1, 94, 242, 106, 36, 0, 0, 0, 0, 73, 69, 78, 68,
    174, 66, 96, 130,
  ]));
