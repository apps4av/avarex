...
/// Dart port of com.ds.avare.adsb.gdl90.LongReportMessage
/// Adjust imports/names if your project uses different conventions.
class LongReportMessage extends TrafficReportMessage {
  int hour = 0;
  int min = 0;
  int sec = 0;
  ...
  void parse(Uint8List msg) {
    ...
    // time of reception is 3 bytes (little-endian in original code)
    ...
    // byte [12], bit 8: altitude type (ignored in original)
    int codedAltitude = 0;
    ...
    if (airborne) {
      ...
      trueHeading = false;
      heading = (360.0 +
          (-math.atan2(-eastVelocityMagnitude.toDouble(), northVelocityMagnitude.toDouble()) *
              180.0 /
              math.pi)) %
          360.0;
