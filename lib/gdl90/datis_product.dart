...
/// FIS-B product 9 — Digital ATIS (TWGO text, same envelope as NOTAM).
class DatisProduct extends Product {
  DatisProduct(super.time, super.data, super.coordinate, super.productFileId, super.productFileLength, super.apduNumber, super.segFlag);
  ...
  @override
  String decode() => graphicsSummary("D-ATIS");

  @override
  String shortName() => "D-ATIS";
}
