...
8. After you tap **Done**, AvareX offers a **Watch a demo?** popup. **Watch** plays the registered tours (MAP, PLAN, FIND, notes, takeoff and landing, and instrument tiles); **Choose a topic** opens the demo list; **Not now** skips it. You can start a demo later from `MAP → Menu → Watch Demo`.
...
- IO (Android only)
- Watch Demo (app presses the real buttons to show MAP, PLAN, FIND, notes, takeoff and landing, and instrument tiles)
...
- **Play all** runs the registered tours in order: Map controls, Build a plan, Find a destination, Write a note, Takeoff and landing, Instrument tiles.
...
- The notes tour does **not** tap **Clear** or **Save**.
...
3. Tap **Play all** or a single topic (`Map controls`, `Build a plan`, `Find a destination`, `Write a note`, `Takeoff and landing`, `Instrument tiles`).
4. Watch the spotlight and pointer tap **Menu**, **Center**, plan **Create**, FIND search, `Write a Note`, `Aircraft & Performance`, instrument tiles, and other controls. The app **speaks** what each control does. Use **Pause**, **Skip**, or **Exit** at the top right.
